...
//      $clip_duration = 240; // New clip duration - 
//      $clip_timer_shift = 220; // Timer shift - $clip_timer_shift = $clip_duration
//  Execute:
//      php -f split_video_by_time.php 

$dir_input = 'z:/video/inp'; // Input dir with files video mp4
$dir_output = 'z:/video/out'; // Output dir with files video mp4
$clip_duration = 240; // New clip duration - 
$clip_timer_shift = 220; // Timer shift - $clip_timer_shift = $clip_duration
